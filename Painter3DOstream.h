...
#ifndef CGAL_QT_PAINTER3D_OSTREAM_H
#define CGAL_QT_PAINTER3D_OSTREAM_H
...
public:
  Painter3DOstream(QPainter* p, QRectF rect = QRectF())
    : qp(p), convert(rect)
  {}

  Painter3DOstream& operator<<(const Point_2& p)
  {
    qp->drawPoint(convert(p));
    return *this;
  }
  
  Painter3DOstream& operator<<(const Segment_2& s)
  {
  ...
  Painter3DOstream& operator<<(const Ray_2& r)
  {
  ...
  Painter3DOstream& operator<<(const Line_2& l)
  {
  ...
  Painter3DOstream& operator<<(const Triangle_2& t)
  {
    qp->drawPolygon(convert(t));
    return *this;
  }

  Painter3DOstream& operator<<(const Iso_rectangle_2& r)
  {
    qp->drawRect(convert(r));
    return *this;
  }

  Painter3DOstream& operator<<(const Bbox_2& bb)
  {
    qp->drawRect(convert(bb));
    return *this;
  }

  Painter3DOstream& operator<<(const Circle_2& c)
  {
  ...
  Painter3DOstream& operator<<(const Circular_arc_point_2& p)
  {
    typedef typename K::Point_2   Point_2;
  ...
  Painter3DOstream& operator<<(const Circular_arc_2& arc)
  {
  ...
  Painter3DOstream& operator<<(const Line_arc_2& arc)
  {
