...
#ifndef CGAL_QT_CONVERTER3D_H
#define CGAL_QT_CONVERTER3D_H
...
class Converter3D {
public:
	typedef typename K::Point_3				CGAL_POINT_3;
	typedef typename K::Line_3				CGAL_LINE_3;	
...
public:
	...
	CGAL_Point_3 operator()(const QPointF& qp) const
	{
	    return CGAL_Point_3(qp.x(), qp.y());
	}
